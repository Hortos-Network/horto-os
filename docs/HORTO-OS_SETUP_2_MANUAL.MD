...
cp /srv/horto-os/config/os-configuration.env /srv/active_setup/
nano /srv/active_setup/os-configuration.env
```

Edit the `os-configuration.env` file to set your desired hostname.
